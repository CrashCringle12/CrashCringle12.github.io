...
const SpecialChartSearch = () => {
  ...
  React.useEffect(() => {
    updateTitle(`${userData.name} | Chart Search`);
  }, [userData]);
  ...
  React.useEffect(() => {
    const updateFilteredResults = () => {
      ...
      const visiblePages = 20; // Number of visible page items
    ...
    content = (
      <>
        <Container className="d-flex justify-content-center">
          <Title size={"h2"} text={"Search 'Other' Charts"} />
        </Container>
...
export default SpecialChartSearch;
